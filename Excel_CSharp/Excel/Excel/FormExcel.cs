...
namespace Excel
{
    public partial class FormExcel : Form
    {
        ...
        private static String _Arquivo = @"Z:\_siscob\Empregados.xlsx";
        ...
        private void btnNovo_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < 2; i++)
            {
                ...
                _oleCmd.Parameters.Add("@CodFunci", OleDbType.Integer).Value = Convert.ToInt32(i);

                //_oleCmd.Parameters.Add("@NomeFunci", OleDbType.VarChar, 255).Value = txtNomeFunci.Text.Trim();
                _oleCmd.Parameters.Add("@NomeFunci", OleDbType.VarChar, 255).Value = @"teste" + DateTime.Now;

                _oleCmd.ExecuteNonQuery();


                this.lblContador.Text = i.ToString();
                this.lblContador.Refresh();
